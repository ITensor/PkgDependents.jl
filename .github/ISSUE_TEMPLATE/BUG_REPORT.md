---
name: PkgDependents.jl bug report
about: Create a bug report to help us improve PkgDependents.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("PkgDependents")`:
```julia
julia> using Pkg; Pkg.status("PkgDependents")
[YOUR OUTPUT HERE]
```
